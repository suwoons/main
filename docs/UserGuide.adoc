...
* Items in square brackets are optional e.g `name/NAME [t/TAG]` can be used as `name/John Doe t/friend` or as `name/John Doe`.
...
* `addStudent name/Betsy Crowe Daphne matric/A1234567X t/friend email/betsycrowe@example.com t/CS2103`
