...
Format: `addTutorial mod/MODULE tutorialName/TUTORIAL_NAME day/WEEKDAY beginTime/START_TIME endTIme/END_TIME place/PLACE`
...
* `addTutorial mod/CS2103 tutorialName/T02 day/Wed beginTime/12:00 endTime/13:00 place/SR3`
* `addTutorial mod/CS1101S tutorialName/T11 day/Wednesday beginTime/12:00 endTime/13:00 place/SR3`

=== Delete a tutorial slot: `deleteTutorial`

Delete a tutorial slot for a particular module. +
Format: `deleteTutorial mod/MODULE tutorialName/TUTORIAL_NAME`
...
* `deleteTutorial mod/CS2103 tutorialName/T02`

=== View details of a tutorial slot: `viewTutorial`

Display all the details of a particular tutorial slot. +
Format: `viewTutorial mod/MODULE tutorialName/TUTORIAL_NAME`
...
* `viewTutorial mod/CS2103 tutorialName/T02`
...
Format: `markPresent mod/MODULE tutorialName/TUTORIAL_NAME week/WEEK student/STUDENT [OPTIONAL]`
...
* `markPresent mod/CS2103 tutorialName/T02 week/7 student/John Tan` +
Marks only John Tan as present for CS2103 tutorial T02 in week 7
* `markPresent mod/CS2103 tutorialName/T02 week/7` +
...
Format: `markPresent mod/MODULE tutorialName/TUTORIAL_NAME week/WEEK student/STUDENT`
...
* `markAbsent mod/CS2103 tutorialName/T02 week/7 student/Jane Tan` +
Marks only Jane Tan as absent for CS2103 tutorial T02 in week 7
* `markAbsent mod/CS2103 tutorialName/T02 week/7` +
...
Format: `viewAttendance mod/MODULE tutorialName/TUTORIAL_NAME week/WEEK [OPTIONAL]`

****
* The `week/WEEK` is optional; if no `week/` is included, then the attendance for all the weeks in the semester will be shown
...
* `viewAttendance mod/CS2103 tutorialName/T02 week/7` +
Displays the attendance list for CS2103 T02 in week 7
* `viewAttendance mod/CS2103 tutorialName/T02` +
