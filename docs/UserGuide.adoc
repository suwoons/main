...
Format: `addConsult beginTime/BEGINDATETIME endTime/ENDDATETIME place/PLACE`
...
* `addConsult beginTime/2020-03-03 10:00 endTime/2020-03-03 12:00 place/The Deck`

=== Editing a consult: `editConsult`

Edit the time, date or place of an existing consultation slot. +
Format: `editConsult INDEX [beginTime/BEGINDATETIME] [endTime/ENDDATETIME] [place/PLACE]`
...
* `editConsult 1 beginTime/15:00` +
Edits the beginning time of the 1st consult to be at 15:00 hours i.e 3.00 p.m.
* `edit 2 place/SR3` +
...
Format: `addTutorial m/MODULE tutorialName/TUTORIAL_NAME day/WEEKDAY_VALUE beginTime/START_TIME endTIme/END_TIME place/PLACE`
...
* `addTutorial m/CS2103 tutorialName/T02 day/3 beginTime/12:00 endTime/13:00 place/SR3`
* `addTutorial m/CS1101S tutorialName/T11 day/4 beginTime/12:00 endTime/13:00 place/SR3`

=== Delete a tutorial slot: `deleteTutorial`

Delete a tutorial slot for a particular module. +
Format: `deleteTutorial m/MODULE tutorialName/TUTORIAL_NAME`
...
* `deleteTutorial m/CS2103 tutorialName/T02`
...
Format: `markPresent m/MODULE tutorialName/TUTORIAL_NAME week/WEEK student/STUDENT [OPTIONAL]`
...
* `markPresent m/CS2103 tutorialName/T02 week/7 student/John Tan` +
Marks only John Tan as present for CS2103 tutorial T02 in week 7
* `markPresent m/CS2103 tutorialName/T02 week/7` +
...
Format: `markPresent m/MODULE tutorialName/TUTORIAL_NAME week/WEEK student/STUDENT`
...
* `markAbsent m/CS2103 tutorialName/T02 week/7 student/Jane Tan` +
Marks only Jane Tan as absent for CS2103 tutorial T02 in week 7
* `markAbsent m/CS2103 tutorialName/T02 week/7` +
...
Format: `viewAttendance m/MODULE tutorialName/TUTORIAL_NAME`

Example:

* `viewAttendance m/CS2103 tutorialName/T02` +
...
Format: `addTutorialStudent m/MODULE tutorialName/TUTORIAL_NAME student/STUDENT`
...
* `addTutorialStudent m/CS2103 tutorialName/T03 student/A0123456Z`

=== Remove student from tutorial: `deleteTutorialStudent`

Remove an existing student from an existing tutorial.
Format: `deleteTutorialStudent m/MODULE tutorialName/TUTORIAL_NAME student/STUDENT`
...
* `deleteTutorialStudent m/CS2103 tutorialName/T03 student/A0123456Z`
//end::Tutorial[]
