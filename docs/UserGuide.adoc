...
* Navigate through the past command history by pressing the up and down arrow button.
...
* Press kbd:[Esc] to cancel and close the suggestion window.
...
* Click on the left and right arrows or press them on your keyboard to change the month displayed.
****
