...
Format: `addTutorial mod/MODULE tutorialName/TUTORIAL_NAME day/WEEKDAY beginTime/START_TIME endTIme/END_TIME location/LOCATION`
...
* The location provided should be any valid string
****

Example:

* `addTutorial mod/CS2103 tutorialName/T02 day/Wed beginTime/12:00 endTime/13:00 location/SR3`
* `addTutorial mod/CS1101S tutorialName/T11 day/Wednesday beginTime/12:00 endTime/13:00 location/SR3`
