...
Format: `addStudent n/NAME m/MATRIC_NUMBER e/EMAIL [t/TAG]...`
...
Format: `editStudent INDEX [n/NAME] [m/MATRIC_NUMBER] [e/EMAIL] [t/TAG]...`
...
* `editStudent 1 e/johndoe@example.com` +
Edits the matric number and email address of the 1st person to be `A9999999Z` and `johndoe@example.com` respectively.
* `editStudent 2 n/Betsy Crower t/` +
