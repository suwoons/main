...
.After adding student Roy and calling `listAttendance`
image::addTutorialStudent.png[]
...
.After deleting student Alex from a tutorial and calling `listAttendance`
image::deleteTutorialStudent.png[]
