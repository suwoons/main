...
.  Should be able to be scaled for use past 1000 students.
...
[[events]] Events::
Events are things which the Teaching Assistant is required to take note of. The Teaching Assistant will be required to attend these events, which can be in the form of tutorials or consultations.
