...
class DeleteModCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + VALID_MODCODE_INPUT,
            new DeleteModCommand(expectedMod.getModCode()));
    }


    @Test
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeleteModCommand.MESSAGE_USAGE);
        ...
        assertParseFailure(parser, VALID_MODCODE_INPUT + VALID_MODCODE_INPUT,
            String.format(MESSAGE_REPEATED_PREFIXES, DeleteModCommand.MESSAGE_USAGE));
    }
