...
class ViewModInfoCommandParserTest {
    private ViewModInfoCommandParser parser = new ViewModInfoCommandParser();
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + VALID_MODCODE_INPUT,
            new ViewModInfoCommand(expectedMod.getModCode()));
    }


    @Test
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, ViewModInfoCommand.MESSAGE_USAGE);
        ...
        assertParseFailure(parser, VALID_MODCODE_INPUT + VALID_MODCODE_INPUT,
            String.format(MESSAGE_REPEATED_PREFIXES, ViewModInfoCommand.MESSAGE_USAGE));
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + VALID_MODCODE_INPUT,
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, ViewModInfoCommand.MESSAGE_USAGE));
    }
